...
function MessageCard({ isActive }) {
  ...
  const message = `Hey Prerna,

Happy Birthday to you 💙❤️
I hope you’re doing okay.
No matter what’s been happening between us, you still matter to me deeply.
You’ve been an important part of my life, and that doesn’t disappear suddenly :).

What we shared wasn’t small, and the time since then hasn’t been easy —
I’m sure you feel the same way.
There’s been confusion, distance, and emotions we never fully unpacked.
But my care for you remains real, whether you believe it or not.

Today is about you, and I wanted you to feel remembered and valued.

Not everything needs to be said loudly.
Some things are felt and understood.
This message comes from that place.

You have this way of making ordinary days better.
Without even trying, without even knowing it.
It’s in your laugh, your words, your presence.
And yeah… it matters more than you think.

I don’t say everything out loud, but it’s there.
The care, the respect, the warmth I feel.
You’ve been a part of moments I won’t forget.
And that alone makes this worth writing.

On your birthday, I just hope you feel appreciated —
Not just today, but in all the days ahead.
May this year bring you closer to what you want.
You deserve kindness, success, and peace.

And may you smile a little more every day ❤️
...
— Another Chico 💙`;
  ...
  return (
    <section className="message">
      <h2>💌 This Part Is Just for You 💌</h2>
        ...
        >
          ...
          {!curtainsOpened && (
            <div ref={curtainHintRef} className="curtain-hint">
              ✨ {window.innerWidth <= 768 ? "Tap" : "Click"} Gently 💙 ✨
            </div>
          )}
        </div>
